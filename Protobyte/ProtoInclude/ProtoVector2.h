...
namespace ijg {
	...
	typedef ProtoVector2<float> Vec2f;
	typedef Vec2f Vec2; // most common usage
	typedef ProtoVector2<double> Vec2d;
	typedef ProtoVector2<int> Vec2i;
	typedef ProtoVector2<long> Vec2L;
	typedef ProtoVector2<short> Vec2s;
