...
void ProtoController::init() {
	...
	for (int i = 0; i < pts; i++) {
		...
		vs.push_back(Vec(sin(theta) * r, -370 + i * 23, cos(theta) * r));
	...
	tube = Tube(s1, 8, 18, false, "STG_Flesh/Diffuse_Maps/STG_Flesh_27-diffuse.jpg");
	tube.setTransFuncObj(ProtoTransformFunction(ProtoTransformFunction::SINUSOIDAL, Tup2f{ 2, 274 }, 1));
